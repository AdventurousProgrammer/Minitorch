...
def tensor_map(fn):
    ...
    def _map(out, out_shape, out_strides, in_storage, in_shape, in_strides):
        ...
        # print(f'Out: {out} out shape: {out_shape} In Storage: {in_shape}')
        for i in range(0, len(in_storage)):
...
def tensor_reduce(fn):
    ...
    def _reduce(
        ...
        # print(f'Reduce Size: {reduce_size}')
        out_index = np.zeros(MAX_DIMS)
        a_index = np.zeros(MAX_DIMS)
