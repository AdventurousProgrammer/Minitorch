    ...
    class Backend:
        ...
        class Mul(Function):
            ...
            def backward(ctx, grad_output):
                ...
                return mul_zip(y, grad_output), mul_zip(x, grad_output)
        ...
        class Sigmoid(Function):
            ...
            def backward(ctx, grad_output):
                # TODO: Implement for Task 2.3.
                x = ctx.saved_values
                return sigmoid_map(x) * (1 - sigmoid_map(x)) * grad_output
                # raise NotImplementedError('Need to implement for Task 2.3')
        ...
        class ReLU(Function):
            ...
            def backward(ctx, grad_output):
                # TODO: Implement for Task 2.3.
                x = ctx.saved_values
                return relu_back_zip(x, grad_output)
                # raise NotImplementedError('Need to implement for Task 2.3')
        ...
        class Log(Function):
            ...
            def backward(ctx, grad_output):
                x = ctx.saved_values
                return log_back_zip(x, grad_output)
                # TODO: Implement for Task 2.3.
                # raise NotImplementedError('Need to implement for Task 2.3')
        ...
        class Exp(Function):
            ...
            def backward(ctx, grad_output):
                x = ctx.saved_values
                return mul_zip(exp_map(x), grad_output)
                # TODO: Implement for Task 2.3.
                # raise NotImplementedError('Need to implement for Task 2.3')
        ...
        class Mean(Function):
            ...
            def forward(ctx, a, dim):
                if dim is not None:
                    ...
                    # print(f'Tensor: {a}')
                    ctx.save_for_backward(a.shape[0])
